...
public interface ProductFeignInterface {
    ...
    @RequestMapping("category/findCoupon")
    List<Map<String, Object>> findCoupon(@RequestParam("uid")Integer uid,@RequestParam("goodsId") String goodsId);
   ...
   PageInfo<Map<String, Object>> orderDetail(@RequestParam("order_no")String order_no,@RequestParam("page")int page,@RequestParam("limit")int limit);
    ...
    //申请退款修改状态
    @RequestMapping("/orders/updateReturnStatus")
    boolean updateReturnStatus(@RequestParam("detail_id")Integer detail_id);
    //---------------------------商品评论后台模块--------------------------------

...
/* gmpro-2.0.0/member/4.4.4 gomeFootPrintTpl.js Date:2019-07-30 17:42:13 */
!function () {
...
/* gmpro-2.0.0/member/4.4.4 gomeFootPrintLive.js Date:2019-07-30 17:42:13 */
function footPrint() {
...
footPrint.prototype = {
    init: function () {
        this.myFootprintList(1)
    }, myFootprintList: function (a) {
        var b = this;
        var c = $.cookie("atgregion") || "11010200|\u5317\u4eac\u5317\u4eac\u5e02\u671d\u9633\u533a(\u4e94\u73af\u91cc)|11010000|11000000|110102001";

    }, removeFootprint: function (a) {
        var c = this;

    }, delMyFootprintsDate: function (a) {
        var c = this;

    }, emptyMyFootprints: function () {

    }, footprintRec: function (a, b, c) {
        var d = this, e = $(a);
        var f = $.cookie("atgregion") || "11010200|\u5317\u4eac\u5317\u4eac\u5e02\u671d\u9633\u533a(\u4e94\u73af\u91cc)|11010000|11000000|110102001";
        var g = {
            boxid: c || "box47",
            pid: e.attr("pid"),
        ...
        $(".similar-title").on("click", "a", function () {
            var a = $(this).index();
            $(this).addClass("cur").siblings().removeClass("cur"), $(".tab-box" + a).show().siblings().hide()
        })
    }, mouseBorder: function () {
        $(".footprint-lis,.similar-lis").on("mouseover", function () {
            var a = $(this).index();
            0 == a ? $(this).css("border-color", "#ccc") : a % 4 != 0 && 4 > a ? ($(this).css("border-color", "#ccc"), $(this).prev().css("border-right-color", "#ccc")) : a % 4 != 0 && a >= 4 ? ($(this).css("border-color", "#ccc"), $(this).prev().css("border-right-color", "#ccc"), $(this).parent().children().eq(a - 4).css("border-bottom-color", "#ccc")) : ($(this).css("border-color", "#ccc"), $(this).parent().children().eq(a - 4).css("border-bottom-color", "#ccc"))
        }).on("mouseout", function () {
            $(".footprint-uls li,.similar-uls li").css("border-color", "#eaeaea")
        })
    }, footprintEvent: function () {
        var a = this, b = {};
        $(".footprint-similar").on("click", function () {
            b.productName = $(this).parent().prev().text(), b.imgUrl = $(this).parents("dd").prev().find("img").attr("src"), b.itemUrl = $(this).parent().prev().attr("href"), b.areaPrice = $(this).prev().text(), b.skuId = $(this).attr("sid"), b.productId = $(this).attr("pid"), b.firstCategoryId = $(this).attr("c1Id"), b.thirdCategoryId = $(this).attr("c3Id");
            var c = gomeTemplate("myFootprintSimilar", b);
            $(".footprint-box").html(c), $(".pager").hide(), $(".similar-title a").each(function (b) {
                var c = $(this).attr("data-type");
                a.footprintRec(".tab-container", ".tab-box" + b, c)
            })
        }), $("#footprint-empty").on("click", function () {
            a.emptyMyFootprints()
        }), $(".footprint-close").on("click", function () {
            var b = $(this).attr("hiddenflag");
            var c = $(this);
            a.removeFootprint(b, c)
        }), $(".delDate").on("click", function () {
            var b = $(this).parent().attr("deldate"), c = $(this).parent().next();
            a.delMyFootprintsDate(b, c)
        })
    }
};
var print = new footPrint;
print.init();

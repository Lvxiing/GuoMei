...
(function ($) {
    $.fn.ajaxSubmit = function (options) {
        ...
        if (options.iframe || found) fileUpload(); else $.ajax(options);
...
/* gmpro-2.0.0/member/4.4.4 returnGoodListTpl.js Date:2019-07-30 17:42:11 */
template.helper("changeHrefToNew", function (a) {
    var b = "", c = "", d = "", e = "", f = "";
    if (a.indexOf("myReturnGoodDetail.jsp") > 0) return c = a.split(".jsp")[1], b = "myReturnGoodDetail" + c;
    if (a.indexOf("shippingGroupDetailInfo.jsp") > 0) {
        d = a.split("?")[1].split("&");
        for (var g = 0, h = d.length; h > g; g++) {
            var i = d[g].split("="), j = i[0], k = i[1];
            "orderId" === j && (e = k), "shippingGroupId" === j && (f = k)
        }
        return b = "shippingGroupDetailInfo/" + e + "/" + f
    }
});
/* gmpro-2.0.0/member/4.4.4 returnGoodListLive.js Date:2019-07-30 17:42:11 */
$(function () {
    var q = {duration: "0"}, r = {state: "0", duration: "0"}, s = {state: "0", duration: "1", refundType: ""};
    $(".cont-top-word").html('<span style="font-size:16px;color:#5E5E5E;">\u9000\u6362\u8d27\u5355</span>');
    var u = function (a) {

    };
    var v = function (a) {
        var b = '<div class="bgHidden"></div><div class="popBoxDiv"><h3><i class="closedBtn">\xd7</i></h3><div class="boxContent"><p class="clearfix tip"><b></b><span>\u6559\u80b2\u4f18\u60e0\u5546\u54c1\u7533\u8bf7\u9000\u6362\u8d27\uff0c\u82e5\u6709\u8d60\u54c1\u9700\u8981\u4e00\u540c\u9000\u6362</span></p><p class="buttonList"><a class="cancels" href="javascript:;">\u53d6\u6d88</a><a class="okBtn" href=' + a + ">\u786e\u8ba4</a></p></div></div>";
        $("body").append(b), $(".popBoxDiv .cancels,.popBoxDiv .closedBtn").on("click", function () {
            $(".popBoxDiv").remove(), $(".bgHidden").remove()
        })
    };
    var w = function () {
        var a = '<div class="shade"></div><div class="dialogBox"><p>\u8be5\u5546\u54c1\u552e\u540e\u8bf7\u8054\u7cfb\u5ba2\u670d\u5904\u7406</p><a href="javascript:void(0);" id="dialogBtn">\u786e\u5b9a</a></div>';
    ...
    var y = function (a) {
        if ("1" != a.result.masterResult.returnRequestListRep.responseCode) return void $.commonPop({message: a.result.masterResult.returnRequestListRep.responseDesc || "\u7f51\u7edc\u9519\u8bef\uff0c\u8bf7\u7a0d\u540e\u518d\u8bd5\uff01"});
        var b = a.result.masterResult.pageInfo;
        "N" == b.isHasResult ? o.renderer(f, a.result, $(".returnRecord").find("tbody")) : (o.renderer(c, a.result, $(".returnRecord").find("tbody"), function () {
            $(".hrefGroup p").css("position", "retalive"), $(".cancel").each(function () {
                $(this).live("click", function () {
                    var a = $(this);
                    p = $(this).attr("returnrequestid"), $.commonPop({
                        father: a.parent("p"),
                        htm: '<div class="popBoxDiv" style="position: fixed; top: 50%;left: 50%;"><h3><i class="closedBtn">\xd7</i></h3>                                    <div class="boxContent"><p class="clearfix tip"><span>\u786e\u8ba4\u53d6\u6d88\u6b64\u9000\u6362\u8d27\u5355\uff1f</span></p>                                    <p class="buttonList"><a class="cancels" href="javascript:;">\u53d6\u6d88</a>                                    <a class="okBtn" id="confirmBtn" href="javascript:void(0);">\u786e\u8ba4</a></p></div></div>',
                        customClass: "grey-style",
                        callback: function () {
                            $(".cancels,.closedBtn").click(function () {
                                $(".outer-pop").remove(), $(".supplement-shading").hide()
            ...
            }), $(".pager", $(".returnRecord")).ucPager({
                currentPage: b.currentpage,
                totalPage: b.pagecount,
                pageSize: b.pagesize,
            ...
            var a = {};
            a.orderId = $(this).attr("orderId"), a.shippingGroupId = $(this).attr("shippingGroupId"), a.commerceItemId = $(this).attr("commerceItemId"), a.commerceItemDetailId = $(this).attr("commerceItemDetailId"), a.returnRequestId = $(this).attr("returnRequestId")
        }), $(".supplement-dialog").off("mouseover").off("mouseout"), $(".supplement-dialog").on("mouseover", ".roUploadList", function () {
            $(this).find(".imgBtn").show()
        }).on("mouseout", function () {
            $(this).find(".imgBtn").hide()
        }), $(".supplement-dialog").on("click", ".roUploadList", function () {
            $(this).remove(), $(".upLoadBtn").show(), 0 == $(".upload_img li").length && $(".commit").removeClass("uploadCommit")
        }), $(".supplement-dialog").on("click", ".supplement-close", function () {
            $(".supplement-shading").hide(), $(".supplement-dialog").hide()
        }))
    };
    var z = function (a, b) {
        $("#searchBtn").attr("on", "2")
    ...
    var A = function (a) {
        "N" == a.result.masterResult.hasresult ? o.renderer(f, a.result, $(".refund").find("tbody")) : o.renderer(d, a.result.masterResult, $(".refund").find("tbody"), function () {
            $(".pager", $(".refund")).ucPager({
                currentPage: a.result.masterResult.currentPage,
                totalPage: a.result.masterResult.totalpage,
                pageSize: "",
                clickCallback: function (a) {
                    z($(".refund"), a)
                }
    ...
    var C = window.location.search, D = C.split("=")[0], E = !0;
    searchOderNo = C.split("=")[1], $(".tabs").navTab({
        currentIndex: "" == B ? 0 : "#p2" == B ? 1 : "#p3" == B ? 2 : "#p4" == B ? 3 : 0,
        callback: function (a, b) {
            if (E && D.indexOf("shipId") > 0) return O(searchOderNo), void(E = !1);
            switch (a) {
                case 0:
    ...
    var F = '<option value="1">\u8fd1\u4e09\u4e2a\u6708</option><option value="2">\u4e09\u4e2a\u6708\u524d</option>';
    var G = $(".applyImg"), H = $(".returnRecord"), I = $(".refund");
    G.find(".applyTime").html('<option value="">\u4e0b\u5355\u65f6\u95f4</option>' + F), H.find(".applyTime").add(I.find(".applyTime")).html('<option value="0">\u7533\u8bf7\u65f6\u95f4</option>' + F), H.find(".allState").html('<option value="">\u6240\u6709\u72b6\u6001</option><option value="1">\u5ba1\u6838\u4e2d</option>                <option value="2">\u5ba1\u6838\u901a\u8fc7</option><option value="3">\u5ba1\u6838\u5931\u8d25</option>                <option value="4">\u9000\u6362\u8d27\u5b8c\u6210</option><option value="5">\u5df2\u53d6\u6d88</option>'), I.find(".allState").html('<option value="">\u6240\u6709\u72b6\u6001</option><option value="1">\u5ba1\u6838\u4e2d</option>                <option value="2">\u9000\u6b3e\u4e2d</option><option value="3">\u5ba1\u6838\u5931\u8d25</option>                <option value="4">\u9000\u6b3e\u5b8c\u6210</option><option value="5">\u9000\u6b3e\u5931\u8d25</option>'), I.find(".refundType").html('<option value="">\u9000\u6b3e\u7c7b\u578b</option><option value="102">\u9000\u8d27</option>                <option value="101">\u5df2\u53d6\u6d88\u652f\u4ed8\u8ba2\u5355</option><option value="103">\u5f02\u5e38\u652f\u4ed8\u9000\u6b3e</option>'), G.find("select").change(function () {
        q.duration = $(this).val(), t(G, "1")
    }), H.find("select").change(function () {
        var a = H.find("select").index(this);
        0 == a ? r.duration = $(this).val() || "0" : 1 == a && (r.state = $(this).val() || "0"), x(H, "1")
    }), I.find("select").change(function () {
        var a = $(this);
        a.hasClass("applyTime") ? s.applicateDate = a.val() || "" : a.hasClass("allState") ? s.refundStatus = a.val() || "" : a.hasClass("refundType") && (s.refundType = a.val() || ""), z(I, "1")
    }), $("#searchText").focus(function () {
        var a = $(this).val();
        (a == j || a == k || a == l) && $(this).val("")
    }).blur(function () {
        var a = $(this).val(), b = $(this).siblings().attr("on");
        "" == a && ("0" == b ? $(this).val(j) : "1" == b ? $(this).val(k) : "2" == b && $(this).val(l))
    });

    function J(a) {
        var c = [];

        var d = $.exporters.userId || 0, e = $.exporters.md5str || 0;
        $.fn.ajaxUpload = function (b) {
            return this.each(function (f) {
                var g = $(this);
                var h = "";
                op = $.extend(h, b);
                var i = new AjaxUpload(g, op)
            })
        }, $("#upLoadBtn").ajaxUpload({})
    }

    $(".supplement-dialog").on("click", ".uploadCommit", function () {
        var a = "", b = $("#upLoadBtn").attr("imgPath") ? $("#upLoadBtn").attr("imgPath") : "",
            c = $(".supplement-dialog").attr("returnId"), d = $("#uploadSelect option:selected").val();
        $(".roUploadImg").each(function (b, c) {
            a += b !== $(".roUploadImg").length - 1 || void 0 !== $("#upLoadBtn").attr("imgPath") ? $(this).attr("imgPath") + "," : c.src
        })
    });
    ...
    function K() {
        ...
        a.click(function () {
            $this = $(this);
            var a = $.trim($("#searchText").val()), b = $this.attr("on");
            return a == j ? void $.commonPop({message: "\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u914d\u9001\u5355\u53f7"}) : a == k ? void $.commonPop({message: "\u8bf7\u8f93\u5165\u6b63\u786e\u7684\u9000/\u6362\u8d27\u5355\u53f7"}) : a == l ? void $.commonPop({message: "\u8bf7\u8f93\u5165\u9000\u6b3e/\u53d6\u6d88\u8ba2\u5355\u5355\u53f7"}) : void("0" == b ? L(a) : "1" == b ? M(a) : N(a))
        })
    }
